...
- [ ] Spectral-ecology band separation pass (Krause layering rule: sub=Earth, low-mid=Water/Fire, mid=Wind/Chimes, high=Rain/Birds) — Water's bandpass ranges (900–2800 Hz) and Fire's lowpass ceiling (up to 2200 Hz) currently creep into Wind/Chime's mid register rather than staying low-mid; worth a dedicated pass to pull elements into more distinct bands so they mask each other less, though current overlap hasn't been reported as an audible problem
